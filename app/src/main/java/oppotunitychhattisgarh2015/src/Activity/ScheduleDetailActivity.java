...
import oppotunitychhattisgarh2015.src.Fragment.DetailsFragment;
import oppotunitychhattisgarh2015.src.Fragment.SpeakerFragment;
import oppotunitychhattisgarh2015.src.R;
import oppotunitychhattisgarh2015.src.extra.AppController;
import oppotunitychhattisgarh2015.src.extra.DummyTabContent;
...
//        tHost.addTab(tSpecApple);
    ...
    private void initViews() {
        super.initViews(getResources().getDrawable(R.drawable.logo_new), appController.getSelectedEvent().getName(), getResources().getDrawable(R.drawable.nasscom_logo), null, null);
    }
