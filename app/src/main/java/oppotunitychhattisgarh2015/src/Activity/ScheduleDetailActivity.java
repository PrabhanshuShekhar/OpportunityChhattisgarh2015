...
public class ScheduleDetailActivity extends OpportunityActivity {
    ...
    private void initViews() {
        super.initViews(getResources().getDrawable(R.drawable.logo_new), appController.getSelectedEvent().getName(), getResources().getDrawable(R.drawable.nasscom), null, null);
    }
