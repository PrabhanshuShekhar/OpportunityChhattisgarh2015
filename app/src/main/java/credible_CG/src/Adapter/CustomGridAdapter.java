...
//            this.images = new int[]{R.drawable.schedule, R.drawable.participants_white, R.drawable.facilitator, R.drawable.information, R.drawable.event_team, R.drawable.venue_white, R.drawable.transportations, R.drawable.documents,R.drawable.documents};
            this.images = new int[]{R.drawable.information, R.drawable.event_team, R.drawable.documents,R.drawable.documents,R.drawable.documents,R.drawable.documents};
        }
