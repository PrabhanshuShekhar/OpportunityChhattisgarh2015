...
import credible_CG.src.Adapter.videoAdapter;
...
public class ChhatisgarhInfoActivity extends OpportunityActivity {
    ...
    private void initViews() {
        ...
        super.initViews(getResources().getDrawable(R.drawable.logo_new), "Information", getResources().getDrawable(R.drawable.credible_cg), null, null);
    }
