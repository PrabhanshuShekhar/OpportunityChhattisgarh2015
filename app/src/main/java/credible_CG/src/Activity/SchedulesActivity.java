...
import credible_CG.src.Adapter.CustomListAdapter;
...
//        System.out.println(">>>>> e1speakers size:"+e1speakers.size());
        ...
        List<Speaker> e1speakers = new ArrayList<Speaker>();
        Event e1 = new Event();
        e1.setTime("09:30AM-10:00 AM");
        e1.setName("Registration");
        e1.setDetails("Networking & Registration");
        e1.setSpeakers(e1speakers);


        List<Speaker> e2speakers = new ArrayList<Speaker>();
        Event e2 = new Event();
        e2.setTime("10:00AM-10:05AM");
        e2.setName("Welcome & Inaugural Address");
        e2.setDetails("Mr. A M. Parial, Vice-Chairman, CHiPS");
        Speaker e2s1 = new Speaker();
        e2s1.setName("Mr. A M. Parial");
        e2s1.setDesignation("Vice-Chairman");
        e2s1.setDepartment("CHiPS");
        e2speakers.add(e2s1);
        e2.setSpeakers(e2speakers);

        List<Speaker> e3speakers = new ArrayList<Speaker>();
        Event e3 = new Event();
        e3.setTime("10:05AM-10:45AM");
        e3.setName("Interactive session with GoCG Q&A");
        e3.setDetails("NRDA Presentation by Mr. Rajat Kumar, CEO, NRDA ,ESDM Presentation by Mr. Saurabh Kumar, CEO, CHiPS, Industry Presentation- Mr. Kartikeya Goel, Director of Industries");
        Speaker e3s1 = new Speaker();
        e3s1.setName("Mr. Rajat Kumar");
        e3s1.setDesignation("CEO");
        e3s1.setDepartment("NRDA");

        Speaker e3s2 = new Speaker();
        e3s2.setName("Mr. Saurabh Kumar");
        e3s2.setDesignation("CEO");
        e3s2.setDepartment("CHiPS");

        Speaker e3s3 = new Speaker();
        e3s3.setName("Mr. Kartikeya Goel");
        e3s3.setDesignation("Director of Industries");
        e3s3.setDepartment("Industries");
        e3speakers.add(e3s1);
        e3speakers.add(e3s2);
        e3speakers.add(e3s3);
        e3.setSpeakers(e3speakers);
        ...
        List<Speaker> e4speakers = new ArrayList<Speaker>();
        Event e4 = new Event();
        e4.setTime("10:45AM-11:00AM");
        e4.setName("Tea Break");
        e4.setDetails("");
        e4.setSpeakers(e4speakers);

        List<Speaker> e5speakers = new ArrayList<Speaker>();
        Event e5 = new Event();
        e5.setTime("11:00AM-11:15AM");
        e5.setName("Opening Remarks");
        e5.setDetails("Opening remarks by Mr. Aman Kumar Singh, Principal Secretary, Electronics and IT Department, Special Address by Mr. Vivek Dhand, Chief Secretary, Government of Chhattisgarh");
        Speaker e5s1 = new Speaker();
        e5s1.setName("Mr. Aman Kumar Singh");
        e5s1.setDesignation("Principal Secretary");
        e5s1.setDepartment("Electronics and IT Department");

        Speaker e5s2 = new Speaker();
        e5s2.setName("Mr. Vivek Dhand");
        e5s2.setDesignation("Chief Secretary");
        e5s2.setDepartment("Government of Chhattisgarh");
        e5speakers.add(e5s1);
        e5speakers.add(e5s2);
        e5.setSpeakers(e5speakers);


        List<Speaker> e6speakers = new ArrayList<Speaker>();
        Event e6 = new Event();
        e6.setTime("11:15AM-11:30AM");
        e6.setName("Industry Leaders Speak");
        e6.setDetails("Ms. Debjani Ghosh, Managing Director, Intel Technology , Mr. Nitin Kunkolienker, Vice President, Smartlink Network Systems Ltd");
        Speaker e6s1 = new Speaker();
        e6s1.setName("Ms. Debjani Ghosh");
        e6s1.setDesignation("Managing Director");
        e6s1.setDepartment("Intel Technology");

        Speaker e6s2 = new Speaker();
        e6s2.setName("Mr. Nitin Kunkolienker");
        e6s2.setDesignation("Vice President");
        e6s2.setDepartment("Smartlink Network Systems Ltd");
        e6speakers.add(e6s1);
        e6speakers.add(e6s2);
        e6.setSpeakers(e6speakers);

        List<Speaker> e7speakers = new ArrayList<Speaker>();
        Event e7 = new Event();
        e7.setTime("11:30AM-11:45AM");
        e7.setName("Key Note address by Honble CM");
        e7.setDetails("Key Note address by Hon. CM Dr Raman Singh");
        Speaker e7s1 = new Speaker();
        e7s1.setName("Dr Raman Singh");
        e7s1.setDesignation("Honble CM");
        e7s1.setDepartment("Chhattisgarh");
        e7speakers.add(e7s1);
        e7.setSpeakers(e7speakers);


        List<Speaker> e8speakers = new ArrayList<Speaker>();
        Event e8 = new Event();
        e8.setTime("12:00PM-01:45PM");
        e8.setName("Tour of Naya Raipur");
        e8.setDetails("");
        e8.setSpeakers(e8speakers);

        List<Speaker> e9speakers = new ArrayList<Speaker>();
        Event e9 = new Event();
        e9.setTime("01:45PM-02:30PM");
        e9.setName("Networking Lunch");
        e9.setDetails("");
        e9.setSpeakers(e9speakers);

        List<Speaker> e10speakers = new ArrayList<Speaker>();
        Event e10 = new Event();
        e10.setTime("02:30PM-04:00PM");
        e10.setName("MAIT Executive Council Meeting");
        e10.setDetails("");
        e10.setSpeakers(e10speakers);
...
//        eventList.add(e12);
    ...
    private void initViews() {
        super.initViews(getResources().getDrawable(R.drawable.logo_new), "Schedule", getResources().getDrawable(R.drawable.mait),null,null);
    }
